...
const get = ({ startOfWeekIndex = 0 }) => {
	const { subscribe, set, update } = writable({ startOfWeekIndex });
...
const get_ = ({ selected, start, end, startOfWeekIndex = 0, shouldEnlargeDay = false }) => {
